<template>
 <div
        class="w-full md:flex px-6 md:px-12 mb-10 text-left leading-normal md:border-l border-gray"
      >
        <div class="w-full md:w-1/2 md:pr-12 pt-8 md:pt-0 md:text-right md:border-r border-gray">
           <h2 class="font-display text-3xl md:text-5xl font-bold text-center md:text-left md:text-4xl mt-8 md:mt-0 md:ml-0 mb-2 mx-auto md:mt-12 md:mb-2 md:pt-0 md:ml-0 leading-tight md:leading-normal font-medium w-full">Follow us</h2>
          <p class="text-xl text-center md:text-left font-body">
          ...
          <p class="text-xl font-display font-bold text-center md:text-left mt-4 md:mt-6 md:text-right font-primary">(But if you insist...)</p>
     
        </div>
        <div class="md:w-1/2 md:mt-10 pt-0 md:pl-12 md:pt-8" style="position: relative">
