<template>
 <div class="w-full" id="projects">
            <h2 class="font-display text-3xl md:text-4xl font-bold text-center md:text-4xl mt-8 md:mt-0 md:ml-8 mb-1 mx-auto md:mt-12 md:mb-8 md:pt-0 md:ml-0 leading-tight md:leading-normal font-medium w-full">What else are we working on?</h2>
                ...
                >
                  ...
                  >
                    <div class="category_header">
                      ...
                      <h3 class="font-display font-bold" :style="{ color: '#' + category.color }">
                        {{ category.name }}
                      </h3>
                    </div>
                  </a>
                  ...
                  <div
                    class="category_description font-body"
                    v-html="
